...
let peopleFullCopy =people.map(s=>({...s}));
...
let man3FullCopy ={...man3, friends:man3.friends.map(s=>s)}
...
let man5FullCopy ={...man5,mother:{...man5.mother,work:{...man5.mother.work}, parents:man5.mother.parents.map(s=>s)}}
...
let man6FullCopy  ={...man6,mother:{...man6.mother, work:{...man6.mother.work},
        parents:man6.mother.parents.map(s=>({...s,favoriteDish:{...s.favoriteDish}}))}}
...
let man7FullCopy  ={...man7,mother:{...man7.mother, work:{...man7.mother.work},
        parents:man7.mother.parents.map(s=>({...s,favoriteDish:{...s.favoriteDish,ingredients:[...s.favoriteDish.ingredients]}}))}}